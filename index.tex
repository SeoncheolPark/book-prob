...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacitybacktitle=0.6, breakable, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remark}, colback=white, toprule=.15mm, toptitle=1mm, opacityback=0, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, left=2mm, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
